  ...
  return (
    <main className="min-h-screen bg-background text-slate-900">
      ...
      <section className="mx-auto w-full max-w-5xl px-6 py-12 md:px-8">
        ...
        <h1 className="mt-3 text-4xl text-[#0b235c] md:text-6xl">MicroBird in plain English</h1>
        <p className="mt-6 text-slate-700 md:text-lg">
          ...
          project is about making identification practical at the edge: record a short clip, run a compact model on a
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          <article className="rounded-3xl bg-card p-6 shadow-sm ring-1 ring-slate-200">
            <h2 className="text-2xl text-[#0b235c]">The problem</h2>
          ...
          <article className="rounded-3xl bg-card p-6 shadow-sm ring-1 ring-slate-200">
            <h2 className="text-2xl text-[#0b235c]">The approach</h2>
            <p className="mt-3 text-sm leading-relaxed text-slate-700">
              Convert audio to spectrogram features and run a quantized CNN directly on a low-power accelerator so the
              system can work offline in the field, with 3.5 ms CNN latency and 15.3 µJ inference energy.
            </p>
          </article>
          <article className="rounded-3xl bg-card p-6 shadow-sm ring-1 ring-slate-200">
            <h2 className="text-2xl text-[#0b235c]">The impact</h2>
            <p className="mt-3 text-sm leading-relaxed text-slate-700">
              Faster feedback during surveys, lower operating cost, and a path to wider acoustic monitoring without
              always depending on cloud infrastructure. The full 3-second pipeline is around 0.69 mJ per clip.
            </p>
          </article>
        </div>

        <div className="mt-10 rounded-3xl bg-card p-7 shadow-sm ring-1 ring-slate-200">
          <h2 className="text-3xl text-[#0b235c]">Try it now</h2>
