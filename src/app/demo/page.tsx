  ...
  return (
    <main className="min-h-screen bg-background text-slate-900">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-12 md:px-8">
        ...
        <h1 className="font-display mt-3 text-4xl text-[#0b235c] md:text-6xl">Live Demo Video</h1>
        <p className="mt-4 max-w-3xl text-slate-700 md:text-lg">
          This walkthrough shows the full flow from recording audio to receiving top predictions from the MAX78002
          on-chip classifier.
        </p>
